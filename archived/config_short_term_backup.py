# config_short_term_backup.py
"""
Backup of the original 5-stock configuration for short-term.
Use this if you need to revert to the original config temporarily.
"""
