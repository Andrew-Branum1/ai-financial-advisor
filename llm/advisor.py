...
def _build_prompt(kpis: dict, weights: dict, user_goal: str, user_profile: dict = None) -> str:
...
async def generate_investment_report(kpis: dict, weights: dict, user_goal: str, user_profile: dict = None) -> str:
